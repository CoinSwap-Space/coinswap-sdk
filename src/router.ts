...
/**
 * The parameters to use in the call to the CoinSwap Router to execute a trade.
 */
...
/**
 * Represents the CoinSwap Router, and has static methods for helping execute trades.
 */
